...
begin
  ...
  select jsonb_build_object(
    ...
    'itens',coalesce(jsonb_agg(jsonb_build_object(
      ...
      'id',i.id,'tipo',i.tipo,'destaque_site',i.destaque_site,'produto',i.produto,'material',i.material,'cor',i.cor,'categoria',i.categoria,
  ...
  ) into v_result from public.itens i where i.empresa_id=v_empresa and i.exibir_no_site=true and i.ativo=true and i.tipo in ('Item', 'Kit');
  return v_result;
end;
$$;
