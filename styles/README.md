...
- `tables.css`: tabela padrao global, cabecalho com a cor da empresa suavizada, hover e espacamento.
...
- Cores oficiais: use `--el-color-primary` para textos fortes neutros e `--el-color-accent` para a cor principal da marca.
...
- Campos: use `.el-input`, `.el-select`, `.el-textarea` ou deixe o campo dentro de `.el-page`; o foco da cor principal sera aplicado.
