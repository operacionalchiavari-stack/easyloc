(function () {
  ...
  const LOCAL_CATALOG = [
    ...
    ["comercial.contratos.visualizar", "Comercial", "Contratos", "visualizar", "Visualizar modelos de contrato", false],
    ["comercial.contratos.criar", "Comercial", "Contratos", "criar", "Criar modelos de contrato", false],
    ["comercial.contratos.editar", "Comercial", "Contratos", "editar", "Editar modelos de contrato", false],
    ["comercial.contratos.excluir", "Comercial", "Contratos", "excluir", "Excluir modelos de contrato", true],
    ...
    ["logistica.expedicao.visualizar", "Logistica", "Expedicao", "visualizar", "Visualizar expedicao", false],
    ["logistica.expedicao.distribuir", "Logistica", "Expedicao", "editar", "Distribuir itens nos caminhoes", false],
    ["logistica.expedicao.carregamento", "Logistica", "Expedicao", "aprovar", "Executar conferencia de carregamento", true],
